      ...
      >
        ...
        >
          ...
          <motion.a
            ...
            whileHover="hover"
            whileTap={{ scale: 0.97 }}
            className="group relative w-full sm:w-auto flex items-center justify-center gap-3 px-8 py-3 rounded uppercase font-black text-sm overflow-hidden shadow-xl transition-shadow"
            style={{
          ...
          <motion.a
            ...
            whileHover="hover"
            whileTap={{ scale: 0.97 }}
            className="group relative w-full sm:w-auto flex items-center justify-center gap-3 px-8 py-3 rounded uppercase font-black text-sm text-foreground border border-border bg-secondary/40 backdrop-blur-xl transition-all duration-300"
            onMouseEnter={(e) => {
